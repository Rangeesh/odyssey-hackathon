    ...
    for segment_index, start_time, end_time, segment_lyrics in segments:
        ...
        if os.path.exists(img_filename):
            ...
            generated_img_path = generate_image_from_lyrics(
                lyrics_context, output_file=img_filename, segment_lyrics=segment_lyrics
            )

        if generated_img_path:
            video_prompt = f"Subtle animation of {segment_lyrics}, dark cartoon style, minimal motion, atmospheric, landscape orientation"
